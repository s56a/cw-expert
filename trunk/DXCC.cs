...
namespace CWExpert
{
    public partial class DXCC : Form
    {
        ...
        public int DXpos(string wntd, string[] dxcl)
        {
            cqww = true;
            zon = "  ";
            itu = "  ";
            ...
            if (wntd != cty)
                ...
                dxpos = k;
            ln = dxcl[dxpos];
            cty = ln.Substring(0, 4);
            if (zon == "  ")
            {
                if (cqww)
                    zon = ln.Substring(8, 2);
                else
                    itu = ln.Substring(6, 2);
            }
            /*
                        if (cont == "  ")
                            cont = ln.Substring(4, 2);
                        beam = ln.Substring(10, 3) + " ";
                        wf = (cty.Equals("K   ") || cty.Equals("VE  "));
            */
            return dxpos;
        }
        ...
        public void Portable(string call)
        {
                ...
                if (!call.StartsWith("Q"))
                {
                    ...
                    else
                    {
                        if (IsCall(call))
                        {
                            ...
                            int mm = DXpos(cty, dxcl);
                            string text = (call + "   " + cty + " " + dxcl[mm]);
                            Debug.Write(text + "\n");
                            result = text + "\n";
